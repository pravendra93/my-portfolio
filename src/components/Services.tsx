...
const services = [
  {
    ...
    description: "End-to-end intelligent software solutions.",
    icon: Cpu,
  ...
  },
  {
    ...
    description: "Launch your core business logic fast.",
    icon: Rocket,
  ...
  },
  {
    ...
    description: "Automate complex tasks with autonomous agents.",
    icon: Bot,
  ...
  },
  {
    ...
    description: "Battle-tested cloud architecture for scale.",
    icon: Database,
