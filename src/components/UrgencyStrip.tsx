...
export function UrgencyStrip() {
  return (
    <div className="hidden sm:block w-full bg-brand-cyan/10 border-b border-brand-cyan/20 py-2 px-6 relative z-[100] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          <p className="text-[10px] font-black text-white/70 uppercase tracking-widest hidden md:block">
